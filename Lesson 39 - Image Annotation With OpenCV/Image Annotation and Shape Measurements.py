...
cv2.putText(image_rgb, 'Reigon 1', (top_left1[0], top_left1[1] - 10), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Reigon 2', (top_left2[0], top_left2[1] - 10), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 1 ', (center1_x[0], center1_y[1] - 10), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
cv2.putText(image_rgb, 'Center 2', (center2_x[0], center2_y[1] - 10), font, 0.7, (255, 255, 255), 2, cv2.LINE_AA)
